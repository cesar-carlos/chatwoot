...
namespace :evolution do
  desc 'Smoke-test validation-checklist §2–4 against a real Evolution instance'
...
class EvolutionValidateChecklist
  ...
  def check_or_require_qr!
    return puts('§4 connect QR: skipped (instance already open)') if @state == 'open'
