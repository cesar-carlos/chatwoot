module Redis::RedisKeys
  ...
  EVOLUTION_GO_IMPORT_LOCK = 'EVOLUTION_GO_IMPORT_LOCK::%<channel_id>d'.freeze
  EVOLUTION_CONTACT_ENRICHMENT = 'EVOLUTION_CONTACT_ENRICHMENT::%<contact_id>d'.freeze
  EVOLUTION_GO_CONTACT_ENRICHMENT = 'EVOLUTION_GO_CONTACT_ENRICHMENT::%<contact_id>d'.freeze
  EVOLUTION_CONTACTS_REFRESH_LOCK = 'EVOLUTION_CONTACTS_REFRESH_LOCK::%<channel_id>d'.freeze
  EVOLUTION_GO_CONTACTS_REFRESH_LOCK = 'EVOLUTION_GO_CONTACTS_REFRESH_LOCK::%<channel_id>d'.freeze
  EVOLUTION_GO_WEBHOOK_TOUCH_DEBOUNCE = 'EVOLUTION_GO_WEBHOOK_TOUCH_DEBOUNCE::%<channel_id>d'.freeze
  # FORK: debounce Wavoip last_webhook_at channel writes under call bursts
  WAVOIP_WEBHOOK_TOUCH_DEBOUNCE = 'WAVOIP_WEBHOOK_TOUCH_DEBOUNCE::%<channel_id>d'.freeze
  EVOLUTION_GO_IMPORT_REMOTE_JIDS = 'EVOLUTION_GO_IMPORT_REMOTE_JIDS::%<channel_id>d'.freeze
  EVOLUTION_LOST_MESSAGES_THROTTLE = 'EVOLUTION_LOST_MESSAGES_THROTTLE::%<channel_id>d'.freeze
  EVOLUTION_GROUP_METADATA_FETCH_LOCK = 'EVOLUTION_GROUP_METADATA_FETCH_LOCK::%<channel_id>d::%<group_jid>s'.freeze
