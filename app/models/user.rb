...
#  captain_embedding_model   :string
#  captain_firecrawl_api_key :string
#  captain_openai_api_key    :string
#  captain_openai_endpoint   :string
#  captain_openai_model      :string
...
# Indexes
#
#  index_users_on_captain_firecrawl_api_key  (captain_firecrawl_api_key)
#  index_users_on_captain_openai_api_key     (captain_openai_api_key)
...
class User < ApplicationRecord
  ...
  encrypts :groq_token if Chatwoot.encryption_configured? # FORK: encrypt Groq API token at rest
