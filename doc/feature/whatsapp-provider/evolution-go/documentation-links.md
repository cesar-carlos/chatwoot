...
| Edit | `POST` | `/message/edit` | [edit-a-message](https://docs.evolutionfoundation.com.br/evolution-go/edit-a-message) | 3 ✅ outbound; inbound plaintext ✅ / encrypted skip [#92](https://github.com/evolution-foundation/evolution-go/issues/92) |
