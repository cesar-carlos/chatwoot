...
| Mensagem sem anexo e sem erro visível | `MediaAttachmentService` agora marca `evolution_go_media_failed` quando `downloadmedia` retorna base64 vazio; checar `content_attributes` da mensagem |
